...
router.get('/restaurant/:id/dashboard', authenticated, restController.resDashboard)
...
router.get('/users/:id/edit', authenticated, authenticatedAdmin, userController.editUser)
router.put('/users/:id', authenticated, authenticatedAdmin, upload.single('image'), userController.putUser)
